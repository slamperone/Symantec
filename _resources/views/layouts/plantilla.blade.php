...
<section class="seccion" id="agenda">
    <div class="agenda-white">
        ...
        <ul>
            <li><span>08:00 | </span>Registro</li>
            <li><span>09:00 | </span>La Disrupción de la Ciberdefensa Integrada
                <p>La ciberdefensa integrada unifica la nube y la seguridad local para brindar protección contra amenazas, protección de la información y cumplimiento en todos los puntos finales, redes, correo electrónico y aplicaciones en la nube.</p>
            </li>
            <li><span>09:20 | </span>Resultados del Reporte Anual a las Amenazas de Seguridad en Internet
                <p>Visión general del panorama de amenazas, incluyendo información sobre la actividad global de amenazas, tendencias en ciber delitos y motivaciones de ataque.</p>
            </li>
            <li><span>10:00 | </span>La Defensa Holística del Endpoint
                <p>¿Cuál es el significado real de una visión holística del endpoint? Es importante en esta vista incluir Prevención , Hardening, Administración Inteligente, Detección y respuesta a incidencias, Analisis basado en inteligencia artificial, compliance en ambientes on premise, cloud o equipos legacy?</p>
            </li>
            <li><span>11:00 | </span>Break
            </li>
            <li><span>11:15 | </span>Protección de la Información, Indicadores de Seguridad y Privacidad
                <p>Mejores prácticas para cumplir y orientar una defensa de protección de datos, no importando su ubicación, uso, movimiento o flujo en una red Zero Trust .</p>
            </li>
            <li><span>12:15 | </span>Modelo "Zero Trust" para Protección de Redes
                <p>La protección y el control son principios de seguridad que requieren un marco de seguridad para datos y amenazas de acceso a la identidad en la red, de manera integrada y coherente.</p>
            </li>
            <li><span>13:15 | </span>Democratizando la Protección de Nube
                <p>Comprenda las implicaciones y los desafíos al migrar hacia la nube y cómo crear un entorno de arquitectura seguro con operaciones de seguridad descentralizadas.</p>
            </li>
        </ul>
    </div>
</section>
<section class="seccion" id="lugar">
    <div class="infomapa">
       ...
       <div class="mapa-azul">
			...
			<p>La entrada al estacionamiento es por la calle Teapa a un costado del edificio. El costo del estacionamiento es de $30 pesos por hora. El evento tendrá una duración de 7 horas. Symantec dará las 5 primeras horas en cortesía, las horas restantes correrán por cuenta del invitado.</p>
		</div>
    </div>
